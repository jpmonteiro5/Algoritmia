...
public class Jogo {
    ...
    public static void labirinto() {
        ...
        System.out.println("Iniciando o labirinto com o herói " + heroi.getClass().getSimpleName() + " " + heroi.getNome() +
                ...
                "Força: " + heroi.getForca() + ", Vida: " + heroi.getHp() + ", Ouro: " + heroi.getOuro() + ".");
        ...
        ArrayList<TipoHeroi> tiposHeroi = new ArrayList<>();
        tiposHeroi.add(TipoHeroi.CAVALEIRO);
        tiposHeroi.add(TipoHeroi.ARQUEIRO);
        tiposHeroi.add(TipoHeroi.FEITICEIRO);
        ...
        ArrayList<TipoHeroi> todosTiposHeroi = new ArrayList<>();
        todosTiposHeroi.add(TipoHeroi.CAVALEIRO);
        todosTiposHeroi.add(TipoHeroi.ARQUEIRO);
        todosTiposHeroi.add(TipoHeroi.FEITICEIRO);


        // Combinação 5
        ArrayList<TipoHeroi> heroiCavaleiro = new ArrayList<>();
        heroiCavaleiro.add(TipoHeroi.CAVALEIRO);
        // Faça o que precisa com a combinacao5

        // Combinação 6
        ArrayList<TipoHeroi> heroiArqueiro = new ArrayList<>();
        heroiArqueiro.add(TipoHeroi.ARQUEIRO);
        // Faça o que precisa com a combinacao6

        // Combinação 7
        ArrayList<TipoHeroi> heroiFeiticeiro = new ArrayList<>();
        heroiFeiticeiro.add(TipoHeroi.FEITICEIRO);
